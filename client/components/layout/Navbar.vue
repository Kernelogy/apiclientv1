          ...
          <a class="nav-item hero-brand" href="/">
            ...
            <tooltip placement="right" type="success" size="small" :no-animate="true" :always="true" :rounded="true">
              <div class="is-hidden-mobile">
                <span class="vue">Dexter</span><strong class="admin">Dojo</strong>
              </div>
            </tooltip>
          </a>
        </div>
        <div class="nav-right is-flex">
          <router-link v-if="!$auth.check()" to="/Signin" class="nav-item">Signin</router-link>
          <router-link v-if="!$auth.check()" to="/Signup" class="nav-item"><button class="button is-primary">Signup</button></router-link>
